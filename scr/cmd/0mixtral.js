module.exports = {
  config: {
    name: "mixtral",
    description: "Interact with the Mixtral AI",
    usage: "<query>",
    cooldown: 5,
    accessableby: 0,
    category: "AI",
  ...
  start: async function ({ api, text, react, event, reply, User }) {
    ...
    try {
      ...
      const response = await get(`https://ggwp-yyxy.onrender.com/api/mixtral-8b?q=${encodeURIComponent(query)}`);

      react("✅");

      await api.editMessage(`🤖 | 𝙼𝚒𝚡𝚝𝚛𝚊𝚕 𝚁𝚎𝚜𝚙𝚘𝚗𝚜𝚎\n━━━━━━━━━━━━━━━\n${response.data.result}\n━━━━━━━━━━━━━━━`, message.messageID);
    } catch (e) {
